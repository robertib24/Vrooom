...
namespace Vrooom.Services.UserServices
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<User> userManager, SignInManager<User> signInManager, IOpenAIService openAIService, IS3Service s3Service, IEmailSender emailSender, IPostareRepo postareRepository)
        {
